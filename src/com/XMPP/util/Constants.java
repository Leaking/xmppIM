...
public class Constants {
	...
	public final static int COLOR_COMMON_WHITE = Color.argb(60, 0x83, 0xed,
			0xb8);
	public final static int COLOR_COMMON_GOLD = Color.argb(0xff, 0xfe, 0xd7,
			0x00);
	public final static int COLOR_COMMON_RED = Color.argb(0xff, 0xee, 0x42,
			0x56);
	public final static int COLOR_COMMON_BLACK = Color.argb(0xee, 0x00, 0x00,
			0x00);
	...
	//
	public final static String FILETYPE_FILE = "common file";
	public final static String FILETYPE_SOUND = "sound file";
